...
struct SettingsView: View {
    @AppStorage("roadmiles.notifyEnabled") private var notifyEnabled: Bool = true
    @AppStorage("roadmiles.compactMode") private var compactMode: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/roadmiles-app/privacy.html")!)
                    Text("Version 1.0")
